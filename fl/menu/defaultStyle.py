...
def init(gui):
    #Surface Loading
    buttonsurf = pygame.image.load("res/img/menuoption/button.png").convert_alpha()
    closesurf = pygame.image.load('res/img/menuoption/closebutton.png').convert_alpha()
    shadesurf = pygame.image.load('res/img/menuoption/shadebutton.png').convert_alpha()
    checksurf = pygame.image.load('res/img/menuoption/checkbox.png').convert_alpha()
    optionsurf = pygame.image.load('res/img/menuoption/optionbox.png').convert_alpha()
    combosurf = pygame.image.load('res/img/menuoption/combobox.png').convert_alpha()
